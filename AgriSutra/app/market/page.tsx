...
export default function MarketPage() {
  ...
  const chartData = {
    ...
    datasets: [
      {
        label: t("marketPage.minPrice"),
        data: data.map(item => item["Min Price"]),
        fill: false,
        borderWidth: 2,
      },
      {
        label: t("marketPage.maxPrice"),
        data: data.map(item => item["Max Price"]),
        fill: false,
        borderWidth: 2,
      },
      {
        label: t("marketPage.modelPrice"),
        data: data.map(item => item["Model Price"]),
        fill: false,
        borderWidth: 2,
      },
    ],
  ...
  const chartOptions = {
    ...
    plugins: {
      ...
      title: {
        display: true,
        text: t("marketPage.chartTitle") || "Market Prices Over Time",
      },
    },
    scales: {
      x: {
        title: {
          display: true,
          text: t("marketPage.date") || "Date",
        },
      },
      y: {
        title: {
          display: true,
          text: t("marketPage.price") || "Price",
        },
      },
    },
  };
