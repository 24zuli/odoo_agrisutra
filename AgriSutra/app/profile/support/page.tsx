...
export default function HelpAndSupportPage() {
  ...
  // ArrowLeft button explicitly goes to "/profile"
    ...
    <div className="min-h-screen bg-gray-100">
      ...
      <div className="bg-white p-6 shadow-sm">
        ...
        <p className="text-gray-600 mt-2">
          {t("helpSupportPage.howCanWeHelp")}
        </p>
      </div>
      ...
      <div className="max-w-4xl mx-auto mt-8 px-4">
        ...
        <ul className="space-y-4">
          <li className="bg-white p-4 rounded-lg shadow-sm">
            <p className="font-semibold">{t("helpSupportPage.faq1Question")}</p>
            <p className="text-sm text-gray-500 mt-1">
              {t("helpSupportPage.faq1Answer")}
            </p>
          </li>
          <li className="bg-white p-4 rounded-lg shadow-sm">
            <p className="font-semibold">{t("helpSupportPage.faq2Question")}</p>
            <p className="text-sm text-gray-500 mt-1">
              {t("helpSupportPage.faq2Answer")}
            </p>
          </li>
          <li className="bg-white p-4 rounded-lg shadow-sm">
            <p className="font-semibold">{t("helpSupportPage.faq3Question")}</p>
            <p className="text-sm text-gray-500 mt-1">
