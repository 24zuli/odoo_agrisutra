...
if platform.system() == "Windows":
    ...
    print("⚠ Warning: Unsupported OS detected. Ensure Tesseract is installed and added to PATH.")
...
#                 extracted_values[key] = float(match.group(1))
#             else:
#                 print(f"⚠ {key} not found. Using default value: {required_parameters[key]}")
#                 extracted_values[key] = required_parameters[key]  # Use default if missing
